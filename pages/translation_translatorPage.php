                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
								...
								<h4 class="page-title">当前项目</h4>-->
							   
							   
							   
                                        <!--<div class="button-list mt-3">
                                            <a href="UPLOAD.html" target = "_blank" type="button" class="btn btn-outline-primary" >添加翻译文件</a>
                                        </div>-->
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>07-12-2019</td>
                                                        <td>
                                                            <a href="#!" class="btn btn-icon btn-primary mr-1" data-toggle="tooltip" title="编辑（进入翻译任务页面）"><i class="feather icon-edit-2"></i></a>
