...
var url="../action/get_TransMemory.php";

xmlhttp.onreadystatechange=function()
  {
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("ShowTransM").innerHTML=xmlhttp.responseText;
    }
  }
                                ...
                                <div class="card-body table-border-style">
                                    <div class="table-responsive">
                                        <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
                                            <thead>
					<tr align="right"><th colspan="6"><a href="UPLOAD-TM.php"><button type="button" class="btn btn-sm btn-secondary">上传翻译记忆文档</button></a></th></tr>
                                                <tr>
                                                    <th width="80px">原文</th>
                                                    <th width="80px">译文</th>
